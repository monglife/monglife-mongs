...
import com.monglife.mongs.adapter.in.admin.character.web.dto.response.AdminPingResponseDto;
...
public class AdminHealthController {
    ...
    public ResponseEntity<ResponseDto<AdminPingResponseDto>> ping(@AuthenticationPrincipal Passport passport) {
        ...
        return ResponseEntity.ok(AdapterInAdminCharacterWebResponse.PING.toResponseDto(dto));
    }
}
