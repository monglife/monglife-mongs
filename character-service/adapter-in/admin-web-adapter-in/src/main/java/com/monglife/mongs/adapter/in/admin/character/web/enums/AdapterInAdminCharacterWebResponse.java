...
public enum AdapterInAdminCharacterWebResponse implements Response {
    ...
    DELETE_MONG(HttpStatus.OK.value(), "MONGS-CHARACTER-ADMIN-014", "몽 삭제에 성공했습니다."),
    GET_TASKS(HttpStatus.OK.value(), "MONGS-CHARACTER-ADMIN-015", "몽 스케줄 목록 조회에 성공했습니다."),
    PAUSE_TASK(HttpStatus.OK.value(), "MONGS-CHARACTER-ADMIN-016", "몽 스케줄 일시 중지에 성공했습니다."),
    RESUME_TASK(HttpStatus.OK.value(), "MONGS-CHARACTER-ADMIN-017", "몽 스케줄 재시작에 성공했습니다."),
    GET_EVOLUTION_HISTORIES(HttpStatus.OK.value(), "MONGS-CHARACTER-ADMIN-018", "몽 진화 이력 조회에 성공했습니다."),
    GET_INVENTORIES(HttpStatus.OK.value(), "MONGS-CHARACTER-ADMIN-019", "인벤토리 목록 조회에 성공했습니다."),

    GRANT_INVENTORY(HttpStatus.OK.value(), "MONGS-CHARACTER-ADMIN-020", "인벤토리 아이템 지급에 성공했습니다."),

    GET_STATS(HttpStatus.OK.value(), "MONGS-CHARACTER-ADMIN-021", "통계 조회에 성공했습니다."),
